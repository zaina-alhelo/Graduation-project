            ...
            <div class="row mb-minus-30">
                <div class="col-xl-4 col-md-6">
                    <div class="blog__item mb-30">
                        <a href="blog-details.html" class="blog__item-media d-block position-relative overflow-hidden">
                            ...
                            <img class="img-fluid" src="{{ asset('landing/images/blogh1.jpg') }}" alt="image not found">
                        </a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog__item mb-30">
                        <a href="blog-details.html" class="blog__item-media d-block position-relative overflow-hidden">
                            <div class="panel wow"></div>
                            <img class="img-fluid" src="{{ asset('landing/images/blogh2.jpg') }}" alt="image not found">
                        </a>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="blog__item mb-30">
                        <a href="blog-details.html" class="blog__item-media d-block position-relative overflow-hidden">
                            <div class="panel wow"></div>
                            <img class="img-fluid" src="{{ asset('landing/images/blogh3.jpg') }}" alt="image not found">
                        </a>
